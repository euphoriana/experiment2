...
HD_PWD='D:/MyVivado/experiment2/IF_ID/IF_ID.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalTop.tcl
