...
HD_PWD='D:/MyVivado/experiment2/IF_ID/IF_ID.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FinalTop.tcl -notrace
